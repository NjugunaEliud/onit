    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M12 2C10.067 2 8.5 3.567 8.5 5.5C8.5 7.433 10.067 9 12 9C13.933 9 15.5 7.433 15.5 5.5C15.5 3.567 13.933 2 12 2ZM12 7C11.172 7 10.5 6.328 10.5 5.5C10.5 4.672 11.172 4 12 4C12.828 4 13.5 4.672 13.5 5.5C13.5 6.328 12.828 7 12 7ZM4 20C4 17.34 9.33 16 12 16C14.67 16 20 17.34 20 20V21H4V20ZM6 19C6.072 18.314 8.695 18 12 18C15.305 18 17.928 18.314 18 19H6Z"
              fill="currentColor"
            />
          </svg>
        ),
      ...
      },      
      {
        icon: (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M13 2.75C13 2.33579 13.3358 2 13.75 2H18.25C18.6642 2 19 2.33579 19 2.75V4.75C19 5.16421 18.6642 5.5 18.25 5.5H13.75C13.3358 5.5 13 5.16421 13 4.75V2.75ZM14.75 3.5V4H17.25V3.5H14.75ZM4.70711 11.2929C4.31658 10.9024 3.68342 10.9024 3.29289 11.2929L2.29289 12.2929C1.90237 12.6834 1.90237 13.3166 2.29289 13.7071L8.29289 19.7071C8.68342 20.0976 9.31658 20.0976 9.70711 19.7071L10.7071 18.7071C11.0976 18.3166 11.0976 17.6834 10.7071 17.2929L4.70711 11.2929ZM5.41421 13.2929L9.29289 17.1716L8.29289 18.1716L4.41421 14.2929L5.41421 13.2929ZM17.0858 8.29289L11.2929 14.0858L12.7071 15.5L18.5 9.70711L21.5 12.7071C21.8905 13.0976 22.5236 13.0976 22.9142 12.7071C23.3047 12.3166 23.3047 11.6834 22.9142 11.2929L19.7071 8.08579C19.3166 7.69526 18.6834 7.69526 18.2929 8.08579L17.0858 9.29289L17.0858 8.29289Z"
              fill="currentColor"
            />
          </svg>
        ),
        ...
        route: "#",
        children: [
          { label: "Live", route: "/grand/live" },
          { label: "Closed", route: "/grand/closed" },
          { label: "Winners", route: "/grand/winners" },
        ],
      },            
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Live", route: "/daily/live" },
          { label: "Closed", route: "/daily/closed" },
          { label: "Winners", route: "/daily/winners" },
        ],
      },            
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Live", route: "/weekly/live" },
          { label: "Closed", route: "/weekly/closed" },
          { label: "Winners", route: "/weekly/winners" },
        ],
      },            
      {
        icon: (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12 2C6.47715 2 2 6.47715 2 12C2 14.1858 2.63317 16.2313 3.75736 17.9497L1.70711 20C1.31658 20.3905 1.31658 21.0237 1.70711 21.4142C2.09763 21.8047 2.7308 21.8047 3.12132 21.4142L5.17157 19.3639C6.88901 20.4881 8.93452 21.1213 11.1213 21.1213C16.6239 21.1213 21.1213 16.6239 21.1213 12C21.1213 7.47715 16.6239 2 12 2ZM4 12C4 7.58172 7.58172 4 12 4C16.4183 4 20 7.58172 20 12C20 14.3316 18.9688 16.3969 17.3674 17.9057L14.1569 14.6953C14.5621 14.2145 14.8288 13.566 14.8288 12.8284C14.8288 11.4536 13.7107 10.3284 12.3431 10.3284C10.9706 10.3284 9.84315 11.4536 9.84315 12.8284C9.84315 14.1998 10.9677 15.3284 12.3431 15.3284C13.0729 15.3284 13.7314 15.0489 14.2071 14.6213L17.4393 17.8536C15.8203 19.3014 13.5984 20.1213 11.1213 20.1213C8.64361 20.1213 6.42168 19.3014 4.80374 17.8536L12 12L4.80374 17.8536C4.5691 17.6264 4.34969 17.3866 4.14645 17.1464C4.00427 16.9915 4 16.8066 4 16.6213C4 16.4563 4.0219 16.2973 4.07072 16.1464C4.13817 15.9497 4.22782 15.7736 4.34315 15.6213C4.58645 15.3431 4.87868 15.1287 5.20711 14.9941C5.82313 14.7275 6.62392 14.3284 7.70711 13.6213L5.93934 11.8536C4.80708 12.9004 4 14.3612 4 16V12Z"
              fill="currentColor"
            />
          </svg>
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between  px-6 py-0 lg:py-0 xl:py-0">
          <Link href="/">
            <Image
              width={200}
              height={32}
