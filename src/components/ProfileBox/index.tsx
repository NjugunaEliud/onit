...
const ProfileBox = () => {
  const [adminData, setAdminData] = useState<{ name?: string; email?: string; utype?:string;phone?:string;}>({}); // Initialize as an object
          ...
          <div className="mt-4">
            ...
            {/* <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
              ...
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-dark-3 xsm:flex-row">
                ...
                <span className="text-body-sm">{adminData?.email}</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                <span className="font-medium text-dark dark:text-white">
                  Phone Number
                </span>
                <span className="text-body-sm-sm">{adminData?.phone}</span>
              </div>
            </div> */}
